...
Vector3f LabToRgb(Vector3f lab)
{
	...
	r = (r > 0.0031308f) ? 1.055f * pow(r, 1.0f / 2.4f) - 0.055 : r * 12.92f;
	g = (g > 0.0031308f) ? 1.055f * pow(g, 1.0f / 2.4f) - 0.055 : g * 12.92f;
	b = (b > 0.0031308f) ? 1.055f * pow(b, 1.0f / 2.4f) - 0.055 : b * 12.92f;
